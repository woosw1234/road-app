...
earthwork_page = st.Page("pages/01_earthwork/earthwork.py", title="토공", icon="🚜")
u_channel_page = st.Page("pages/02_drainage/u_channel.py", title="U형측구 수리계산서", icon="🌊")
pavement_page = st.Page("pages/03_pavement/pavement.py", title="포장공", icon="🛣️")
subsidiary_page = st.Page("pages/04_subsidiary/subsidiary.py", title="부대공", icon="🏗️")
